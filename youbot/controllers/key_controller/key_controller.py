...
youbot = Robot()
timestep = int(youbot.getBasicTimeStep())

# actuators
wheel1 = youbot.getDevice("wheel1") #переднее правое
wheel2 = youbot.getDevice("wheel2") #переднее левое
wheel3 = youbot.getDevice("wheel3") #заднее правое
wheel4 = youbot.getDevice("wheel4") #заднее левое
wheel1.setPosition(float('inf'))
wheel2.setPosition(float('inf'))
wheel3.setPosition(float('inf'))
wheel4.setPosition(float('inf'))

while youbot.step(timestep) != -1:
